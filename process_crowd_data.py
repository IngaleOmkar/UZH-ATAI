...
evaluate_crowd_data('data/crowd_data_olat_P344FullstopCorrected.tsv', 'data/crowd_majorty_kappa.json', 'data/new_triplets.json')
clean_malicious('data/crowd_data.tsv', 'data/crowd_majorty_kappa.json', 'data/crowd_data_cleaned.tsv')
evaluate_crowd_data('data/crowd_data_cleaned.tsv', 'data/crowd_majorty_kappa_cleaned.json', 'data/new_triplets.json')
